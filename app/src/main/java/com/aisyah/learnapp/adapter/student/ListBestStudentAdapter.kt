...
class ListBestStudentAdapter : RecyclerView.Adapter<ListBestStudentAdapter.ViewHolder>() {

    private val listStudent = arrayListOf<ModelStudent>()

    fun setBestStudent(students: List<ModelStudent>?) {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ListBestStudentAdapter.ViewHolder {
        val view : View = LayoutInflater.from(parent.context).inflate(R.layout.item_students, parent, false)
        return ViewHolder(view)
    }

    override fun onBindViewHolder(holder: ListBestStudentAdapter.ViewHolder, position: Int) {
